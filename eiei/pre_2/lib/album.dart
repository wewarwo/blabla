...
class albumWid extends StatelessWidget {
  // Declare a field that holds the Todo
  final int id;
  // In the constructor, require a Todo
  albumWid({Key key, @required this.id}) : super(key: key);
          ...
          return new Card(
            ...
            onTap: (){
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => photoWid(id: values[index].id),
                ),
              );
              },
            ),
